...
interface GeneratorCopyrightInterface extends ethers.utils.Interface {
  functions: {
...
export class GeneratorCopyright extends Contract {
  ...
  interface: GeneratorCopyrightInterface;
